...
:script
:type tool
:desc Splits all selected meshes into unique meshes depending on their given smoothing group
"""
import pymxs
    ...
    def run(self, node):
        ...
        if(node_superclass == pymxs.runtime.GeometryClass):
            ...
            for i in range(1, temp_copy.getNumFaces()):
                ...
                face_mat_id = pymxs.runtime.polyOp.getFaceSmoothGroup(temp_copy, face_id)
            ...
            for mat_id in ids_grouped:
                ...
                split_name = temp_copy_name + "_smoothing_group_" + str(mat_id)
